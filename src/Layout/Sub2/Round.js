...
function Round() {
  ...
  const roundTexts = [
    {
      p1: "최고의 인기 게임 모드",
      p2: "공격로에서 상대를 격파하고 5:5 팀 전투에 뛰어들어 적 넥서스를파괴해 보세요.",
    },
    {
      p1: "모두 무작위, 단일 공격로",
      p2: "얼어붙은 다리 위에서 펼쳐지는 박진감 넘치는 5:5 게임 모드입니다.무작위 챔피언으로 팀을 구성해 적의 넥서스를 파괴해 보세요.",
    },
    {
      p1: "8인 난투전",
      p2: "챔피언들로 전략적인 팀을 구성해 결투장으로 진격시키세요. 총 7명의 상대와 겨루어 끝까지 살아남아야 합니다.",
    },
  ];
