            ...
            <ul>
              <li onClick={() => imageChange(0)}>
                ...
                <svg
                  ...
                  viewBox="0 0 100 100"
                  className={0 === number ? "Class_image" : "Class_image_none"}
                >
              ...
              <li onClick={() => imageChange(1)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 100 100"
                  className={1 === number ? "Class_image" : "Class_image_none"}
                >
              ...
              <li onClick={() => imageChange(2)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 100 100"
                  className={2 === number ? "Class_image" : "Class_image_none"}
                >
              ...
              <li onClick={() => imageChange(3)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 100 100"
                  className={3 === number ? "Class_image" : "Class_image_none"}
                >
              ...
              <li onClick={() => imageChange(4)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 100 100"
                  className={4 === number ? "Class_image" : "Class_image_none"}
                >
              ...
              <li onClick={() => imageChange(5)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 100 100"
                  className={5 === number ? "Class_image" : "Class_image_none"}
                >
