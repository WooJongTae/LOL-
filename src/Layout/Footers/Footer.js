...
function Footer() {
  ...
  return (
    <div className="Footer">
      <div className="Footer_service"></div>
      <div className="Footer_icon">
        <ul>
          {socialMediaIcons.map((socialMediaIcon) => (
            <li>
              <a href="#">
                <svg class="" viewBox={socialMediaIcon.viewBox}>
                  <title>{socialMediaIcon.title}</title>
                  <path d={socialMediaIcon.path}></path>
                  <path d={socialMediaIcon.path2}></path>
                </svg>
              </a>
            </li>
          ))}
